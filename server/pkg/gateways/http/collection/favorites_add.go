...
// @Security ApiKeyAuth
// @Router /collections/favorites/add_place/{place_id} [post]
func AddPlaceToFavorites(collectionCase usecase.Collection) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = collectionCase.AddPlaceToFavorites(c, user.ID, placeID)
