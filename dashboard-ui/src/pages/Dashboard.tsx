  ...
  return (
    <div className="text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Places Map Card */}
        <Link to="/places-map" className="bg-gray-800 hover:bg-gray-700 p-6 rounded-lg shadow-md transition-all duration-200 transform hover:-translate-y-1">
          <div className="flex flex-col items-center text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-teal-400 mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
              <path d="M8 14l3-3 2 2 3-3"></path>
              <line x1="8" y1="9" x2="8" y2="9"></line>
            </svg>
            <h2 className="text-xl font-semibold mb-2">Places Map</h2>
            <p className="text-gray-300 text-sm">View all locations on a map</p>
          </div>
        </Link>
